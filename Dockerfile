...
# Install cosign
COPY --from=gcr.io/projectsigstore/cosign:v1.13.1@sha256:ac8e08a2141e093f4fd7d1d0b05448804eb3771b66574b13ad73e31b460af64d /ko-app/cosign /usr/local/bin/cosign
RUN cosign version
