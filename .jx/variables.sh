...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x/jx-goreleaser-image/main/5'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-goreleaser-image:1.0.2'
