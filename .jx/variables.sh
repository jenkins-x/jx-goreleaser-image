...
export APP_NAME='jx-goreleaser-image'
...
export JENKINS_X_URL='https://dashboard-jx.infra.jenkins-x.rocks/jenkins-x/jx-goreleaser-image/main/3'
...
export MINK_IMAGE='ghcr.io/jenkins-x/jx-goreleaser-image:0.1.0'
export NAMESPACE_SUB_DOMAIN='-jx.'
export PIPELINE_KIND='release'
export PUSH_CONTAINER_REGISTRY='ghcr.io'
export REPO_NAME='jx-goreleaser-image'
